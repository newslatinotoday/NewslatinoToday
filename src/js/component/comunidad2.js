	...
	return (
		<React.Fragment>
			...
			/> */}
						...
						<div className="espacio3" />
						<p className="parrafo">
							El ministerio cristiano Comunidad Vida Nueva bajo el lema{" "}
							{'"Mi Prójimo es cualquier persona que tenga necesidad"'}.<br />
							El grupo hispano de Comunidad Vida Nueva, es parte integral de la Iglesia {
								'"Hope Cafe"'
							}{" "}
							...
							Dice el Pastor Nestor Gomez
							<br />
							Agradecemos a la {"'Elder'"} Hanna Broome del Ministerio A.M.E. Zion Church por su
							colaboracion y servicio de amor al prójimo.
							{
							...
							y yo puedo darle de comer. Prójimo es cualquiera que está enfermo y yo puedo visitarlo.
							Prójimo es cualquiera que está necesitado y yo puedo hacer algo por él. Prójimo es cualquier
							extranjero que se siente solo y yo puedo acompañarle. Prójimo es cualquier desconocido y a
							quien yo puedo saludarle cordialmente. Prójimo es cualquiera que vive lejos y a quien yo
							puedo acercarme. La idea de prójimo trasciende lo geográfico, lo cultural, lo social, lo
							religioso. Prójimo es {"“cualquiera”"} al que yo puedo tender una mano. Esta es parte
							esencial en la Vision de {"'Comunidad Vida Nueva'"}
							segun su pastor.
						</p>
						<div className="espacio2" />
						<Link to="/">

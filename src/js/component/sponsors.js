			...
			<div className="container">
						...
						<div className="col-md-8">
							<div className="card-body">
								<p className="card-text">
									AARP es una organización sin fines de lucro, no partidaria y de bienestar social
									compuesta por cerca de 38 millones de socios que ayuda a las personas a convertir
									sus metas y sueños en posibilidades reales.
								</p>
							</div>
						</div>
					</div>
				...
				<div className="float-left">
					<img
						...
						height="200"
						width="200"
						className="img-fluid height-auto max-width-100% logos mr-auto"
						alt="..."
					/>
					<div className="float-right">
						<p>
							AARP es una organización sin fines de lucro, no partidaria y de bienestar social compuesta
							por cerca de 38 millones de socios que ayuda a las personas a convertir sus metas y sueños
					...
					<CardBody>
						<span className="lefttextspam">
							<Link to="/deportes-noticia-uno">
								<strong>LA COCINA MEXICAN RESTAURANT</strong>
							</Link>
						</span>
						<br />
					</CardBody>
				...
				<div>
					<CardBody>
						<span className="lefttextspam">
							<Link to="/deportes-noticia-uno">
								<strong>EL MOLCAJETE MEXICAN RESTAURANT</strong>
							</Link>
						</span>
						<br />
					</CardBody>
				...
				<div>
					<CardBody>
						<span className="lefttextspam">
							<Link to="/deportes-noticia-uno">
								<strong>HOPE CAFE CHURCH</strong>
							</Link>
						</span>
						<br />
					</CardBody>
